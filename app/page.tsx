	...
	useLayoutEffect(() => {
        let ctx = gsap.context(() => {
            ...
            gsap.to(titleTop.current, {
				...
				ease: "sine.inOut",
                top: "2rem",
				left: windowWidth < 1000 ? "45vw" : "12vw",
				fontSize: "3rem"
            });
	...
	return (
		<main className="min-h-screen w-full h-fit relative">
			...
			<div className="h-screen w-full flex justify-center items-center relative">
				<p ref={descriptionRef} className="text-2xl md:text-6xl font-bold text-center max-w-[80%] md:max-w-[60%] text-black" style={{ lineHeight: 1.2 }}>
				...
				<motion.p initial="initial" variants={opacity} animate={isInView||hasBeenInView ? "inView" : "outView"} custom={3} className="absolute left-[10%] top-[10%] max-w-[260px] text-xl text-black">“Amazing!!! I love it here”. - Megan M</motion.p>
				<motion.p initial="initial" variants={opacity} animate={isInView||hasBeenInView ? "inView" : "outView"} custom={5} className="absolute left-[45%] md:left-[70%] top-[18%] md:top-[15%] max-w-[300px] text-xl hidden md:block text-black">“Best nail place in the metro!” - Justine G</motion.p>
				<motion.p initial="initial" variants={opacity} animate={isInView||hasBeenInView ? "inView" : "outView"} custom={4} className="absolute left-[6%] md:left-[6%] top-[75%] max-w-[300px] text-xl hidden md:block text-black">“Kim and Yang are amazing!” - Ruth G</motion.p>
				<motion.p initial="initial" variants={opacity} animate={isInView||hasBeenInView ? "inView" : "outView"} custom={7} className="absolute left-[30%] md:left-[60%] top-[80%] md:top-[85%] text-xl text-black">“No one can compare” - Tearesa D</motion.p>
			</div>
			<div className="h-[50vh] md:h-screen w-full flex justify-center items-center p-4 md:p-14">
				<div className="h-full w-full flex justify-center items-center rounded-3xl bg-black relative">
					<h1 className="absolute left-8 top-8 text-2xl md:text-4xl text-red font-semibold">Contact us</h1>
